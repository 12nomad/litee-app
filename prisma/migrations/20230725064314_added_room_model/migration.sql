...
CREATE TABLE "rooms" (
    ...
    "roomName" TEXT,
    "isGroupRoom" BOOLEAN NOT NULL DEFAULT false,
...
-- CreateIndex
CREATE UNIQUE INDEX "rooms_messageId_key" ON "rooms"("messageId");
...
-- AddForeignKey
ALTER TABLE "rooms" ADD CONSTRAINT "rooms_messageId_fkey" FOREIGN KEY ("messageId") REFERENCES "messages"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
